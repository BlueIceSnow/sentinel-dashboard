...
angular.module("sentinelDashboardApp", ["oc.lazyLoad", "ui.router", "ui.bootstrap", "angular-loading-bar", "ngDialog", "ui.bootstrap.datetimepicker", "ui-notification", "rzTable", "angular-clipboard", "selectize", "angularUtils.directives.dirPagination"]).factory("AuthInterceptor", ["$window", "$state", function (r, t) {
    ...
    a.interceptors.push("AuthInterceptor"), r.config({
        ...
        resolve: {
            loadMyFiles: ["$ocLazyLoad", function (e) {
                return e.load({name: "sentinelDashboardApp", files: ["app/scripts/controllers/flow.js"]})
            }]
        }
...
}]), (app = angular.module("sentinelDashboardApp")).service("FlowService", ["$http", function (a) {
    function t(e) {
        return void 0 === e || "" === e || isNaN(e) || e <= 0
    }

    this.queryMachineRules = function (e, t, r) {
        return a({url: "/flow/rules", params: {app: e, ip: t, port: r}, method: "GET"})
        ...
        return a({url: "/flow/rule", data: e, method: "POST"})
        ...
        return a({url: "/flow/save.json", params: t, method: "PUT"})
    }, this.deleteRule = function (e) {
        var t = {id: e.id, app: e.app};
        return a({url: "/flow/delete.json", params: t, method: "DELETE"})
    ...
    this.queryMachineRules = function (e, t, r) {
        ...
        return a({url: "/degrade/rule", data: e, method: "POST"})
    }, this.saveRule = function (e) {
        var t = {
            id: e.id,
            resource: e.resource,
        ...
        return a({url: "/degrade/rule/" + e.id, data: t, method: "PUT"})
    }, this.deleteRule = function (e) {
        return a({url: "/degrade/rule/" + e.id, method: "DELETE"})
    }, this.checkRuleValid = function (e) {
